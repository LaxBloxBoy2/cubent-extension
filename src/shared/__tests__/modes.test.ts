...
import type { ModeConfig, PromptComponent } from "@cubent/types"
...
describe("FileRestrictionError", () => {
	...
	describe("debug mode", () => {
		it("is configured correctly", () => {
			...
			expect(debugMode).toMatchObject({
				...
				name: "🪲 Debug",
				roleDefinition:
					"You are cubent, an expert software debugger specializing in systematic problem diagnosis and resolution.",
	...
	describe("agent mode", () => {
		it("is configured correctly", () => {
			const agentMode = modes.find((mode) => mode.slug === "agent")
			expect(agentMode).toBeDefined()
			expect(agentMode).toMatchObject({
				slug: "agent",
				name: "Agent",
				roleDefinition:
	...
	describe("agent-auto mode", () => {
		it("is configured correctly", () => {
			const agentAutoMode = modes.find((mode) => mode.slug === "agent-auto")
			expect(agentAutoMode).toBeDefined()
			expect(agentAutoMode).toMatchObject({
				slug: "agent-auto",
				name: "Agent (Auto)",
				roleDefinition:
