...
import { unboundDefaultModelId, unboundDefaultModelInfo } from "@cubent/types"
...
const ORIGIN_APP = "cubent-code"

const DEFAULT_HEADERS = {
	"X-Unbound-Metadata": JSON.stringify({ labels: [{ key: "app", value: "cubent-code" }] }),
}
