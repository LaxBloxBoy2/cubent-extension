...
import { WebDashboardTracker } from "./core/tracking/WebDashboardTracker"

/**
 * Show Cubent usage popup (like Copilot's popup)
 */
async function trackAutocompleteUsage(completionText: string, modelId: string): Promise<void> {
	try {
