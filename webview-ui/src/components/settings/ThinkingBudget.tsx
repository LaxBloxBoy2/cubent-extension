...
import { type ProviderSettings, type ModelInfo, type ReasoningEffort, reasoningEfforts } from "@cubent/types"
...
export const ThinkingBudget = ({ apiConfiguration, setApiConfigurationField, modelInfo }: ThinkingBudgetProps) => {
	...
	// Show basic reasoning settings even when model info is not available
	if (!modelInfo) {
		return (
