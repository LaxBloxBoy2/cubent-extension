...
import { ModeConfig, GroupEntry, PromptComponent, ToolGroup, modeConfigSchema } from "@cubent/types"
									...
									{(listApiConfigMeta || []).map((config) => {
										...
										if (isHeader) {
											return (
												<div
													key={config.id}
													className="px-2 py-1.5 text-xs font-semibold text-vscode-descriptionForeground uppercase tracking-wide border-b border-vscode-widget-border">
									...
									span: (
										<span
											...
											onClick={() => {
												...
												vscode.postMessage({
													type: "openFile",
													text: `./.cubent/rules-${currentMode.slug}/rules.md`,
													values: {
														create: true,
														content: "",
													},
										...
										span: (
											<span
												...
												onClick={() => {
													...
													vscode.postMessage({
														type: "openFile",
														text: `./.cubent/system-prompt-${currentMode.slug}`,
														values: {
															create: true,
															content: "",
														},
