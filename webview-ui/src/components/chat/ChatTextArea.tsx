								...
								return (
									<div
										...
										className={cn(
											...
											"transition-colors",
											context.type === ContextMenuOptionType.Image ? "max-w-none" : "max-w-xs", // No width limit for images
										)}
										...
										{context.type === ContextMenuOptionType.Image ? (
											...
											<img src={materialIcon} alt="File icon" className="w-4 h-4 flex-shrink-0" />
										) : (
											<i
					...
					<div
						...
						<div
							...
							<DynamicTextArea
								...
								style={{
									outline: "none !important",
									border: isDraggingOver ? "2px dashed var(--vscode-focusBorder)" : "0 !important",
									boxShadow: "none !important",
								}}
					...
					<div className={cn("flex", "items-center", "gap-1", "min-w-0")}>
						...
						<div className="shrink-0">
							<SelectDropdown
								...
								triggerClassName="w-full bg-[rgba(255,255,255,0.03)] text-vscode-foreground border-none rounded-md px-3 py-1.5 hover:bg-[rgba(255,255,255,0.05)]"
